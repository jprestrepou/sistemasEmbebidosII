...
set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { C }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { D }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]
...
## LEDs
set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { Y }]; #IO_L24N_T3_35 Sch=led[4]
...
#set_property -dict { PACKAGE_PIN B9    IOSTANDARD LVCMOS33 } [get_ports { C }]; #IO_L11N_T1_SRCC_16 Sch=btn[2]
#set_property -dict { PACKAGE_PIN B8    IOSTANDARD LVCMOS33 } [get_ports { D }]; #IO_L12P_T1_MRCC_16 Sch=btn[3]
...
#set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33     } [get_ports { isns0v95_p }]; #IO_L8P_T1_AD10P_15 Sch=ad_p[1